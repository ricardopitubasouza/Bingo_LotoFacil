 ...
 * @author ricar
 */
public class GraficoDePontosPorPartes {
    
        public void GraficoDePontosPorPartes(int idinicial, int idfinal){
    
        EfetuaConeccao efetuarconeccao = new EfetuaConeccao();
        efetuarconeccao.EfetuaConeccao();
        
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        PontosNaAnteriorSorteiosPorPartes pontosnaanterior = new PontosNaAnteriorSorteiosPorPartes();
